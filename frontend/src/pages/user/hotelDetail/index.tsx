...
const HotelDetail = () => {
  ...
  let found = hotels.find((item) => item._id === id);
  let foundRoom= rooms.find(item=>item.id==id)
  return (
    <div className="hotel-detail-page">
    {
            ...
            <div className="container ">
              ...
              <div className="page-breadcrumb">
                <Breadcrumbs
                  ...
                  style={{ color: "white" }}
                >
                  <Link to="/" className="linkk" style={{ color: "white" }}>
                    Home
                  </Link>
                  <Link
                    to="/location"
                  ...
                  <Typography className="page-name linkk">{found.name}</Typography>
                </Breadcrumbs>
              </div>
            </div>
      ...
      <div className="hotel-page-main-part">
        {found && (
          <div className="container row" key={found._id}>
            <div className="hotel-page-main-sect-left col-12 col-sm-12 col-md-12 col-lg-8 col-xl-8 col-xxl-8">
              <div className="page-header-sect">
                ...
                <div className="review-wrapper">
                  <div className="puan-box">{found.rate}/5</div>
                  <span>Excellent</span>
                  <span className="review">({found.review.length} review)</span>

                  <ul className="location">
                    <li>{found.locationcity}</li>
                  </ul>
                </div>
              </div>
              <div className="about-hotel-sect">
                ...
                <p>
                  ...
                  ideal point of departure for your excursions in Osaka. With
                  its location just from the city center and from the airport,
                  this 3-star property attracts numerous travelers each year.
                  With its convenient location, the property offers easy access
                  to the city’s must-see destinations.
                </p>
                <p>
                  Hotel WBF Hommachi offers many facilities to enrich your stay
                  in Osaka. Guests can enjoy on-site features like free Wi-Fi in
                  all rooms, daily housekeeping, laundromat, wheelchair
                  accessible, 24-hour front desk.
                </p>
                <p>
                  Hotel WBF Hommachi is home to 182 guestrooms. All are
                  tastefully furnished, and many even provide such comforts as
                  towels, carpeting, clothes rack, slippers, flat screen
                  television. The property’s host of recreational offerings
                  ensures you have plenty to do during your stay. Hotel WBF
                  Hommachi is an ideal place of stay for travelers seeking
                  charm, comfort, and convenience in Osaka.
                </p>
              </div>
              ...
              <div className="availability-sect">
                ...
                <div className="available-rooms-wrapper row">
                    {
                        foundRoom && foundRoom.room.map(room=>{
                            return  <div className="room-item col-12 col-xxl-12 col-xl-12 col-lg-12 col-md-6" key={room.roomName}>
                            <div className="room-item-card-row row ">
                              ...
                              <div className="item-card-content col-xl-8 large col-lg-8 col-md-12 col-sm-12  col-xs-12 row">
                                <div className="content-left-sect col-xl-7 large col-lg-7 col-md-12 col-sm-12  col-xs-12">
                                  <div className="upper">
                                    <Link to={"/location/"+found?._id+"/"+room.roomId}>  <h2 className="name">{room.roomName}</h2></Link>
                                  ...
                                  <div className="down-side">
                                    <div className="count-item-wrapper">
                                      ...
                                      <p>
                                        {" "}
                                        <span>{room.square}</span>m<sup>2</sup>
                                      </p>
                                    </div>
                                    <div className="count-item-wrapper">
                                    ...
                                    <div className="count-item-wrapper">
                                      ...
                                      <p>
                                        x<span>{room.childrenCount}</span>
                                      </p>
                                    </div>
                                  </div>
                                </div>
                                <div className="content-right-sect col-xl-5 large col-lg-5 col-md-12 col-sm-12  col-xs-12">
                                  <p>
                                    <span>${room.nightPrice},00</span>
                                    /night
                                  </p>
        
                                  <Link to={"/location/"+found?._id+"/"+room.roomId}><Button type="primary" shape="round" className="btn">
                                    Room Detail
                                  </Button>
                                  </Link>
                                </div>
              ...
              <div className="review-sect">
                ...
                <div className="review-box">
                  <div className="review-box-heading">
                    ...
                    <div className="puan">{found.rate}/5</div>
                    <span>Excellent</span>
                    <span className="review">
                      ({found.review.length} reviews)
                    </span>
                  </div>
                  <div className="reviews-wrapper row">
                    <div className="review-item  col-12 col-sm-12 col-md-12 col-lg-6 row">
                      <div className="review-type col-5">Cleanlines</div>
                      <div className="line col-5"></div>
                      <div className="review-rate col-2">{found.rate}/5</div>
                    </div>
                    <div className="review-item  col-12 col-sm-12 col-md-12 col-lg-6 row">
                      <div className="review-type col-5">Accuracy</div>
                      <div className="line col-5"></div>
                      <div className="review-rate col-2">{found.rate}/5</div>
                    </div>
                    <div className="review-item  col-12 col-sm-12 col-md-12 col-lg-6 row">
                      <div className="review-type col-5">Communication</div>
                      <div className="line col-5"></div>
                      <div className="review-rate col-2">{found.rate}/5</div>
                    </div>
                    <div className="review-item  col-12 col-sm-12 col-md-12 col-lg-6 row">
                      <div className="review-type col-5">Location</div>
                      <div className="line col-5"></div>
                      <div className="review-rate col-2">{found.rate}/5</div>
                    </div>
                    <div className="review-item  col-12 col-sm-12 col-md-12 col-lg-6 row">
                      <div className="review-type col-5">Check-in</div>
                      <div className="line col-5"></div>
                      <div className="review-rate col-2">{found.rate}/5</div>
                    </div>
                    <div className="review-item  col-12 col-sm-12 col-md-12 col-lg-6 row">
                      <div className="review-type col-5">Value</div>
                      <div className="line col-5"></div>
                      <div className="review-rate col-2">{found.rate}/5</div>
                    </div>
                  </div>
              ...
              <div className="hotel-reviews">
                {found.review.map((elem) => {
                  return (
                    <div className="review">
                      <div className="review-heading row">
                        <div className="heading-left-sect col-6 row">
                          <div className="profile-img col-2">
                            <img src={elem.submitterImg} alt="" />
                          </div>
                          <div className="profile-info col-10">
                            <div className="name">{elem.submitterName}</div>
                            <div className="commit-date">{elem.submittime}</div>
                          </div>
                        </div>
                        {/* <div className="heading-right-sect col-6">
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                                      viewBox="0 0 512 512"
                                    >
                      ...
                      <div className="rate">
                        {(Number(elem.accuracyRate) +
                          Number(elem.checkinRate) +
                          Number(elem.cleanlinesRate) +
                          Number(elem.communicationRate) +
                          Number(elem.locationRate) +
                          Number(elem.valueRate)) /
                          6 >
                        4 ? (
                          <>
                            <svg
                      ...
                      <div className="review-content">
                        <p>{elem.submitcontent}</p>
                      </div>
                    </div>
                  );
                })}
              </div>
              <div className="write-review-toggle">
                <Button
                  shape="round"
                  type="primary"
                ...
                >
                  ...
                  <span>{disp ? <ExpandLessIcon /> : <ExpandMoreIcon />}</span>
                </Button>
                <div
                  className="leave-review-sect"
                ...
                >
                  ...
                  >
                    <div className="form-wrapper row">
                      <div className="form-firt-sect form-field col-12 col-sm-12 col-md-6 col-lg-6">
                        <Input
                          size="large"
                          className="inp"
                          placeholder="Name*"
                      ...
                      <div className="form-second-sect form-field col-12 col-sm-12 col-md-6 col-lg-6">
                        <Input
                          size="large"
                          className="inp"
                          placeholder="Email*"
                      ...
                      <div className="form-third-sect form-field col-12 col-sm-12 col-md-12 col-lg-12">
                        <Input
                          size="large"
                          className="inp"
                          placeholder="Title*"
                      ...
                      <div className="form-fourth-sect form-field  col-12 col-sm-12 col-md-12 col-lg-12 ">
                        <div className="items-wrapper row">
                          <div className="rate-item col-6">
                      ...
                      <div className="form-fifth-sect form-field col-12 col-sm-12 col-md-12 col-lg-12">
                        <TextArea
                          rows={4}
                          className="inp"
                          placeholder="Content*"
            ...
            <div className="hotel-page-main-sect-right col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4">
              ...
              <div className="hotel-locate-map">
                ...
                <div></div>
                <Button shape="round" className="map-btn">
                  View in a Map
                </Button>
              </div>
              <div className="hotel-partner-commonication-box">
                <div className="partner-box">
                  ...
                  <div className="partner-name">{found.partnerName}</div>
                </div>
                <p className="member-since">Member Since 2022</p>
                <Button shape="round" type="primary" className="partner-btn">
                  Ask a Question
                </Button>
              </div>
            </div>
