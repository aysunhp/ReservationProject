      ...
      {/* <ul className="menu-dropdown"style={{ display: isVisible === "" ? "none" : "block" ,}} ref={menuDropdownRef}>
       {
        ...
        <Link to="/"><li>Become Loacl Expert</li></Link>
        <Link to="/"><li>Contact</li></Link>
        <Link to="/"><li>Destination</li></Link>
        <Link to="/"><li>FAQ</li></Link></>:isVisible==="car"?<>
        <Link to="/"><li>Car Search Top Bar</li></Link>
        <Link to="/"><li>Detail Car</li></Link>
       </>:isVisible==="rental"?<>
        <Link to="/"><li>Rental Search</li></Link>
        <Link to="/"><li>Detail Rental</li></Link>
        <Link to="/"><li>External Booking</li></Link>
